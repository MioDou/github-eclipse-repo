...
<body class="background1">
	...
	<audio id="poem" src="/static/audio/wanderingEarch-poem.mp3"
		preload="auto"></audio>
    <span id="firstline" style="font-size: 22px; color: white">大家好，我准备设计和实现一个“<span
	...
	<div id="poem-txt"
		...
		《诗词版"流浪地球"》<br /> <span style="font-size: 18px; color: grey">
			———— </span><br /> <br /> 西风吹皱东方河，万年地球白发多。 <br /> 流浪星际家何去，满船清梦出银河。
	</div>
	...
	<div id="hornor" style="display:none;position:absolute;left:10x; bottom:10px;color:white;font-size:24px" align="center">谨以此向<span style="color:red">《流浪地球》</span>表示致敬 !
</body>
</html>